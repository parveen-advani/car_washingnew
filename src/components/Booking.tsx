              ...
              {sent ? (
                ...
                <>
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <Field label="Phone" name="phone" placeholder="+64 20 4122 5212" required />
                  </div>
                  <Field label="Car model" name="car" placeholder="Toyota Corolla 2022" required />
                  <div className="grid gap-4 sm:grid-cols-2">
                    <Select label="Package" name="pkg" options={["Interior Clean — NZ$120", "Exterior Detail — NZ$180", "Full Car Wash — NZ$250"]} />
